...
#' Replicating experimental results -- combining multiple parameter
#' changes to replicate the experimentally-observed patterns of
#' clonal burden.
...
#savePlot(filename = "4G.pdf", width = 200, height.mult = 0.7)
